...
class AmplifierTesterTest {
    ...
    fun `should be able to test amplifier configurations`(rawProgram: String, thrusterSignal: Int) {
        ...
        AmplifierTester.run(program) shouldEqual thrusterSignal
    }
    ...
    fun `should be able to test amplifier configurations with feedback loop`(rawProgram: String, thrusterSignal: Int) {
        val program = Program.parse(rawProgram)

        AmplifierTester.runFeedbackLoop(program) shouldEqual thrusterSignal
    }
}
