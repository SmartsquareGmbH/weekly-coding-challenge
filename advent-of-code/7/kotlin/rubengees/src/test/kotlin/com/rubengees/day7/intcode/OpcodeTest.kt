...
import com.rubengees.day7.intcode.Argument.ArgumentMode.IMMEDIATE
import com.rubengees.day7.intcode.Argument.ArgumentMode.POSITION
import com.rubengees.day7.intcode.Opcode.Add
import com.rubengees.day7.intcode.Opcode.Equals
import com.rubengees.day7.intcode.Opcode.Halt
import com.rubengees.day7.intcode.Opcode.JumpIfFalse
import com.rubengees.day7.intcode.Opcode.JumpIfTrue
import com.rubengees.day7.intcode.Opcode.LessThan
import com.rubengees.day7.intcode.Opcode.Multiply
import com.rubengees.day7.intcode.Opcode.ReadInput
import com.rubengees.day7.intcode.Opcode.WriteOutput
...
class OpcodeTest {
    ...
    fun `reading input for a program with multiple inputs should shift the input`() {
        ...
        val args = listOf(Argument(15, POSITION))

        val result = ReadInput.execute(program, args)

        result.newProgram[15] shouldEqual 1
        result.newProgram.input shouldEqual 2
    }
