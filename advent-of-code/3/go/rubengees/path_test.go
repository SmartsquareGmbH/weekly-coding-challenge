...
func Test_findClosestIntersection(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantIntersection: Intersection{Point: &Point{x: 3, y: 3}, manhattanDistance: 6},
			wantErr:          false,
		},
		{
			name: "",
			...
			wantIntersection: Intersection{Point: &Point{x: 155, y: 4}, manhattanDistance: 159},
			wantErr:          false,
		},
		{
			name: "",
			...
			wantIntersection: Intersection{Point: &Point{x: 124, y: 11}, manhattanDistance: 135},
			wantErr:          false,
		},
	}
...
func Test_findIntersections(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []Intersection{{Point: &Point{x: 4, y: 3}, manhattanDistance: 7}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
